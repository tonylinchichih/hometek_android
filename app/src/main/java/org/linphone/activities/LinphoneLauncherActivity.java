...
public class LinphoneLauncherActivity extends Activity implements ServiceWaitThreadListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        } // Otherwise use drawable/launch_screen layer list up until first activity
        // starts
    }
    ...
    public void onServiceReady() {
        ...
        intent.setClass(LinphoneLauncherActivity.this, com.intellex.hometek.MainActivity.class);
