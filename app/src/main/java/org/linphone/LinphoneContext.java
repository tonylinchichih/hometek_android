...
public class LinphoneContext {
    ...
    private void dumpLinphoneInformation() {
        ...
        Log.i("VERSION NAME=" + com.intellex.hometek.sip.BuildConfig.VERSION_NAME);
        Log.i("VERSION CODE=" + com.intellex.hometek.sip.BuildConfig.VERSION_CODE);
        Log.i("PACKAGE=" + com.intellex.hometek.sip.BuildConfig.APPLICATION_ID);
        Log.i("BUILD TYPE=" + com.intellex.hometek.sip.BuildConfig.BUILD_TYPE);
